  ...
  var i = function () {
    ...
    a = function () {
      e(window).scrollTop() >= 200
        ? e(".navbar.fixed-top").addClass("bg-black")
        : e(".navbar.fixed-top").removeClass("bg-black");
    },
    s = function () {
      ...
      e(".image-zoom")
        ...
        .on("mousemove", function (i) {
          e(this)
            ...
            .css({
              "transform-origin":
                ((i.pageX - e(this).offset().left) / e(this).width()) * 100 +
                "% " +
                ((i.pageY - e(this).offset().top) / e(this).height()) * 100 +
                "%",
            });
        })
        .each(function () {
    ...
    c = function () {
      e(".navbar").on("click", ".search-button", function (i) {
        ...
        e(".search-popup").on("click", function (i) {
          (e(i.target).is(".search-popup-close") ||
            e(i.target).is(".search-popup-close svg") ||
            e(i.target).is(".search-popup-close path") ||
            e(i.target).is(".search-popup")) &&
